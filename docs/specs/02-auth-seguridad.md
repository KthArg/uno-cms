...
| T-59-4  | Usuario inexistente → se verifica igualmente un hash señuelo                       | si no, el tiempo de respuesta revela si el correo existe. **Se afirma contando la llamada, no cronometrando** (#131)                                                                 |
...
| T-59-12 | Una cuenta desactivada no entra ni con la contraseña correcta, y paga el señuelo   | `deactivateUser` (§6) no sirve de nada si la puerta sigue abierta; y responder rápido ahí distingue una cuenta desactivada de una activa con un cronómetro. Añadido en #131: faltaba |
...
| Abuso de uploads        | **M4**                                                                                                                                                                                                                                                                              |
| Enumeración             | T-59-3, T-59-4, T-59-12, T-55-7, T-61-3                                                                                                                                                                                                                                             |
