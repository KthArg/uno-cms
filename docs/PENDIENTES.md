...
| La vista previa de escritorio se ve muy pequeña                           | La columna de la vista previa mide unos 400 px y **no crece con la pantalla**, así que meter 1280 px dentro obliga a encogerla a un tercio: la maqueta se ve, el texto casi no. La alternativa era mentir —lo que había antes, que enseñaba la maqueta de móvil con la etiqueta "Escritorio"— y esa es peor. Ensanchar la columna es tocar la maqueta del editor, que es otra decisión (#138)                                                     |
