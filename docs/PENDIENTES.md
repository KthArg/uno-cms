...
| El enlace de la portada no se valida al renderizar               | Se valida al guardar, pero no al pintarlo. Hoy lo tapan React —que bloquea `javascript:`— y el navegador; ninguna de las dos protecciones es nuestra ni tiene test nuestro. Se cierra con #113, que necesita la misma pieza | [#143](https://github.com/KthArg/uno-cms/issues/143)                                                     |
