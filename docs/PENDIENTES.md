...
| Qué                                                                                    | Por qué se aplazó                                                                                                                                                                                                                                                                                                                                                                                                 | Issue                                                |
| -------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------- |
| `/api/preview/contenido` responde **501** cuando el interruptor está encendido         | #177 construye el interruptor y nada más, porque construir la ruta antes dejaría una ventana con un endpoint que sirve contenido sin publicar y nada que lo apague. El 501 no es el contrato de la spec 08 §4.3: está para que T-R-1 pueda fallar —con un 404 en las dos ramas, quitar la comprobación no rompería nada—. **Desaparece en #179**, y si sigue ahí cuando #179 cierre, es un error, no una decisión | [#179](https://github.com/KthArg/uno-cms/issues/179) |
| T-R-19 y T-R-20 —la renovación vista desde la pantalla— no están comprobados           | #178 deja construida y probada la **decisión** de cuándo renovar, que es lo que hace aceptables quince minutos de vida. Lo que los dos casos afirman es observable solo con el iframe delante: «se renueva sin recargar» y «si falla, se dice y se ofrece recargar». Escribirlos ahora sería afirmar sobre una pantalla que no existe                                                                             | [#180](https://github.com/KthArg/uno-cms/issues/180) |
| Nadie ha comprobado que un iframe a `http://localhost` cargue desde una página `https` | Es el caso «CMS desplegado, web en local» de la spec 08 §1, y tiene reglas propias del navegador —contenido mixto— que no se pueden razonar desde aquí. La CSP lo permite si está en `PREVIEW_ORIGINS`; lo que no se sabe es si el navegador lo bloquea después. Hay que mirarlo con un navegador delante, y toca en #180, que es quien pone el iframe                                                            | [#180](https://github.com/KthArg/uno-cms/issues/180) |
